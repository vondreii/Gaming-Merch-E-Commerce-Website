<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Clothing.aspx.cs" Inherits="MerchKraft1.Pages.Categories.Clothing" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <% td.setCurrentFunction("Clothing"); %>
